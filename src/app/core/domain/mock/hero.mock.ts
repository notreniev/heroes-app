...
export function getHeroesFromServerMock() {
    return {
        "response": "success",
        "results-for": "spider",
        "results": [{
            ...
            "biography": {
                ...
                "alter-egos": "No alter egos found.",
                "aliases": ["Spiderman", "Bag-Man", "Black Marvel", "Captain Universe", "Dusk", "Green Hood", "Hornet", "Mad Dog 336", "Peter Palmer", "Prodigy", "Ricochet", "Scarlet Spider", "Spider-Boy", "Spider-Hulk", "Spider-Morphosis"],
            ...
            "biography": {
                ...
                "first-appearance": "(cameo) Spectacular Spider-Man #263 (1998); (full) Amazing Spider-Man #441 (1998)",
                "publisher": "Marvel Comics",
                "alignment": "good"
            },
            "appearance": {
